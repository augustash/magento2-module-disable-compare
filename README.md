...
<div align="center">
    ...
    <a href="https://github.com/augustash/magento2-module-disable-compare/graphs/commit-activity" target="_blank"><img src="https://img.shields.io/badge/maintained%3F-yes-brightgreen.svg?style=flat-square" alt="Maintained - Yes" /></a>
...
The `Augustash_DisableCompare` module is for easily disabling product comparison functionality in Magento 2.
...
```bash
composer require augustash/module-disable-compare
bin/magento module:enable --clear-static-content Augustash_DisableCompare
